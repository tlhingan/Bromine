...
int main(void)
{
   ...
   char str_WriteRepltyTimeout[32];
   ...
   if (incoming == NULL)
      printf("No data received from the form.");
   else
   {
...
str_ReportFrequency, str_ReportTemperature, str_WriteRepltyTimeout, str_WriteMode, str_AccessPassword, str_TagEncoding, str_session, str_target, str_q, str_tari, str_readPlan, str_ISOBLF,\
str_modulation, str_delimiter, str_region, str_hopTime, str_HopTable);
//       printf("%s\n%s\n", str_description, str_currentTime);
     printf("%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\
\n%s\n", str_description, str_currentTime, str_antenna, str_BaudRate, str_commandTimeout, str_transportTimeout, str_EnableReadFilter, str_ReadFilterTimeout, str_ASyncOffTime,\
str_ASyncOnTime, str_ReadPower, str_WritePower, str_CheckAntenna, str_PortSwitchGPOs, str_InputList, str_OutputList, str_SettlingTime, str_PortRead, str_PortWrite, str_TxRxMap, str_AllowEarlyExit,\
str_EnablePowerSave, str_SJC, str_ExtendedEPC, str_HighestRSSI, str_UniqueAntenna, str_UniqueData, str_PowerMode, str_UserMode, str_ReportAntenna, str_ReportFrequency, str_ReportTemperature,\
str_WriteRepltyTimeout, str_WriteMode, str_AccessPassword, str_TagEncoding, str_session, str_target, str_q, str_tari, str_readPlan, str_ISOBLF, str_modulation, str_delimiter, str_region,\
